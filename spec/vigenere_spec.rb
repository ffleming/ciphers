...
describe Ciphers::Vigenere do
  ...
  it_should_behave_like "a cipher",
    name: "Kryptos 1", key: "PALIMPSEST", alphabet: Ciphers.alphabet_from("KRYPTOS"),
  ...
  it_should_behave_like "a cipher",
    name: "Kryptos 1b",
    alphabet: Ciphers.alphabet_from("KRYPTOS"),
  ...
  it_should_behave_like "a cipher",
    name: "Kryptos 2", key: "ABSCISSA", alphabet: Ciphers.alphabet_from("KRYPTOS"),
